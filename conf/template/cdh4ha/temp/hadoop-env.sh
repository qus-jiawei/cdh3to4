...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$HOME/pkg/lzo/lib:$HOME/hadoop/lib/native/Linux-amd64-64
...
JAVA_LIBRARY_PATH="$HOME/hadoop/lib/native/Linux-amd64-64"
export HADOOP_OPTS="-Djava.library.path=$JAVA_LIBRARY_PATH  -Djava.net.preferIPv4Stack=true $HADOOP_CLIENT_OPTS"
